...
SOURCES = main.c draw_utils.c color_utils.c menus.c timers.c mzapo_phys.c mzapo_parlcd.c serialize_lock.c
...
# Working options that require password for @postel...
# SSH_OPTIONS=-o 'ProxyJump=nazarrod@postel.felk.cvut.cz'
